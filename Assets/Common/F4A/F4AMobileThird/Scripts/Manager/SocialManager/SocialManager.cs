...
namespace com.F4A.MobileThird
{
    ...
    public class F4ASocialSettingInfo
    {
        ...
        public string emailContact = "email@gmail.com";
        ...
        public List<string> facebookPermisions = new List<string>() { "public_profile", "email", "user_friends" };
    ...
    public partial class SocialManager : SingletonMono<SocialManager>
	{
        ...
        {
            string email = socialSettingInfo.emailContact;
